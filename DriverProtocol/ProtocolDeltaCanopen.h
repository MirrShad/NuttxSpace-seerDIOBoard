#ifndef _PROTOCOL_DELTA_CAN_OPEN_H_
#define _PROTOCOL_DELTA_CAN_OPEN_H_
...
class CProtocolDeltaCANOpen
	:public CDriverCanProtocol
{
public:
	
	CProtocolDeltaCANOpen();
	virtual ~CProtocolDeltaCANOpen(){}	
...
typedef NormalSingleton<CProtocolDeltaCANOpen> ProtocolDeltaCANOpen;
